> **ARCHIVE — DO NOT EDIT.** This is the PH3.12 production certification of
> **2026-08-17 (verdict: NO-GO)** together with its **PH3.12R Blocker Remediation
> Addendum**, preserved verbatim as committed at `a4ee79f3e8ba5f689e265a8c804c9e9674717173`.
>
> It was superseded on 2026-08-18 by the independent rerun in
> [`PH3.12_PRODUCTION_CERTIFICATION.md`](./PH3.12_PRODUCTION_CERTIFICATION.md),
> which reoccupies that filename. This copy exists so the original NO-GO verdict
> and the B-1/B-2 remediation evidence remain readable in the working tree and
> not only in git history — the audit trail for the release decision is the whole
> sequence NO-GO → PH3.12R → rerun → PH3.12C, not just its final state.
>
> Nothing below has been edited. Where it conflicts with the rerun report, the
> rerun report is authoritative; this file records what was believed and measured
> at the time.
