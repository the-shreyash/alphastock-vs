    ...
    <div className="min-h-screen flex" style={{ background: "var(--bg)" }} data-testid="register-page">
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12" style={{ background: "var(--bg-surface)" }}>
        <div className="relative z-10 max-w-md">
          ...
          <h1 className="text-4xl font-medium tracking-tight mb-4" style={{ fontFamily: "Outfit", color: "var(--text-primary)" }}>AlphaPartner</h1>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <p className="text-xs uppercase tracking-[0.2em] font-bold mb-1" style={{ color: "var(--text-muted)" }}>Get Started</p>
          <h2 className="text-2xl font-medium tracking-tight mb-8" style={{ fontFamily: "Outfit", color: "var(--text-primary)" }}>Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {[{ id: "register-name-input", label: "Name", type: "text", val: name, set: setName, ph: "Your name" },
              ...
              <div key={f.id}>
                <label className="text-xs font-semibold uppercase tracking-widest block mb-1.5" style={{ color: "var(--text-muted)" }}>{f.label}</label>
