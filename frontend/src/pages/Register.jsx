      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="sa-auth-label" htmlFor="register-name">Name</label>
              <input
                id="register-name"
            ...
            <div>
              <label className="sa-auth-label" htmlFor="register-email">Email</label>
              <input
                id="register-email"
            ...
            <div>
              <label className="sa-auth-label" htmlFor="register-password">Password</label>
