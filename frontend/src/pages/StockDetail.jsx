...
// D6.8-A — whether a technical reading may be shown as a measurement is the
// backend's decision; this only renders it. See lib/fieldQuality.js.
  ...
  return (
    <div data-testid="stock-detail-page" className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* One implementation, in components/stock/TechnicalIndicators.jsx.
            This page used to carry an inline copy of the same card while that
            component sat unimported beside it — two renderings of one readout,
            of which D6.8-A would have corrected only the one it could see. */}
