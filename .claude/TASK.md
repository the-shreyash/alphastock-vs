...
- **LIM-D5.3-3 — freshness and latency can disagree, and D5.4 must reconcile them.** A feed whose ticks are consistently 90 seconds late is fresh by this predicate and bad by any latency measure. D5.4's scoring term must not end up contradicting this one about the same feed.
