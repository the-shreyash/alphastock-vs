...
- [x] WebSocket — Kite ticker (binary LTP + order updates), Upstox portfolio stream (orders) and Upstox v3 market feed (protobuf ticks, D4.7), auto-reconnect w/ backoff
