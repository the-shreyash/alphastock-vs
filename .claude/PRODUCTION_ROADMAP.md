...
- **Status (2026-08-16): 🟡 AUDIT HALF COMPLETE — removal half NOT STARTED.** Delivered under the sprint label **"PH3.8 — Analytics & Data Integrity"**. Report: **`docs/architecture/ANALYTICS.md`**. **Numbering note:** the brief called this PH3.8 and its follow-on PH3.9; this roadmap's PH3.8 is *Accessibility & Responsive Audit* (untouched) and PH3.9 is *End-to-End Critical Journeys* (untouched). Read "PH3.9" in that report as **this item's remaining half**. Same brief-label drift as PH3.2–PH3.7.
